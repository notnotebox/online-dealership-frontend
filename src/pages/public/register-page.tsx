...
export function RegisterPage() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-4 rounded-lg border p-6">
      ...
      <TestHelperCard
        title="Outil de test formateurs"
        description="Remplit le formulaire avec des donnees de demonstration et telecharge un fichier texte."
        buttonLabel="Generer un profil de test"
